...
void tr_date(struct tm *tick_time) {
    ...
    //Sunday = 0
    if (config.language == 1) { //Hungarian - Thanks to Péter G!
    ...
    else if (config.language == 2) { //Bahasa Malaysia - Thanks to Adrian C!
    ...
    else if (config.language == 3) { //Finish - Thanks to Janne K!
...
void tr_month(struct tm *tick_time) {
    ...
    else if (config.language == 3) { //Finish
